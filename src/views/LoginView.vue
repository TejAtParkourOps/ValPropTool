<template>
  <div>
    ...
    <b-alert
      ...
      variant="info"
      class="mx-auto mt-5 text-center"
      :show="infoMsg.length > 0"
    >
      {{ infoMsg }}
    </b-alert>
    <b-card
      style="max-width: 500px"
      class="shadow mx-auto mt-5"
      title="Login With Email"
      :hidden="infoMsg.length > 0"
    >
      <b-card-text>
    ...
    <b-card
      style="max-width: 500px"
      class="shadow mx-auto mt-5"
      title="Login Using Other Methods"
      :hidden="infoMsg.length > 0"
    >
      <b-card-text>
...
export default {
  ...
  methods: {
      ...
      emailLinkSignIn
        ...
        .catch((err) => {
          ...
          switch (errCode) {
            ...
            default:
              this.alertMsg =
                "An unknown error occurred while trying to sign you in.";
          }
        })
        .finally(() => {
          this.busy = false;
    ...
    loginWithGoogle() {
      this.busy = true;
      federatedSignIn
        .signInWithPopup(auth, new federatedSignIn.GoogleAuthProvider())
        .then((response) => {
